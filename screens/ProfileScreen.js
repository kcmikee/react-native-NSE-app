    ...
    <View style={styles.screeen}>
      ...
      <View style={styles.topnav}>
                    <View style={styles.leftHeader}>
                        <Text onpress={()=> navigation.navigate('/')} style={styles.logo}>Profile</Text> 
                    </View>
      ...
      <View style={styles.pro1}>
        <Image style={styles.img} source={require('../assets/images/ProfilePic.PNG.png')} /> 
        <View style={styles.pro2}>
          <View style={styles.pro3}>
              <Text style={styles.pro4}>@Mary_J</Text>
          </View>
          <View style={styles.pro5}>
            <TouchableHighlight onPress={()=>props.navigation.navigate('Update')}>
      ...
      <View style={styles.bio}>
        <Text style={styles.bio2}>Lorem ipsum dolor sit amet consectetur adipisicing elit. Repellat pariatur iusto amet quis nesciunt illo reiciendis ut quas fugiat, iure quod</Text>
      </View>
